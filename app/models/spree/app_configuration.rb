...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    preference :show_raw_product_need_to_know, :boolean, default: false
    preference :show_raw_product_additional_info, :boolean, default: false
    preference :show_raw_product_what_included, :boolean, default: false
